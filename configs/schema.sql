...
CREATE TABLE IF NOT EXISTS friends (
    ...
    FOREIGN KEY (friend_id) REFERENCES users (id) ON DELETE CASCADE ON UPDATE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS comments (
    ...
    FOREIGN KEY (media_id) REFERENCES media (id) ON DELETE CASCADE ON UPDATE RESTRICT,
    FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE ON UPDATE RESTRICT,
    FOREIGN KEY (parent_id) REFERENCES comments (id) ON DELETE CASCADE ON UPDATE RESTRICT
);
